...
I think you can probably already imagine what the agent main design could look like. The core idea behind the business logic is quite interesting, so I’m still refining the design and implementation. I plan to document it properly and release a public version in the future.
